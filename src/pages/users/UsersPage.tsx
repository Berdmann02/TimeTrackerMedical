            ...
            <div className="w-full sm:w-48 flex-shrink-0">
              <div className="relative">
                <select
                  ...
                  className="block w-full pl-3 pr-3 py-2 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white cursor-pointer"
                >
